...
@section('content')
    ...
    <script type="text/javascript">
        ...
        for(x = 1;x <= MAX_X ;++x){
            ...
            $("#slipping-container-master").append('<div id="slipping-container-'+x+'"></div>'); // 添加横向总体载体元素
            $("#slipping-container-"+x).css('width',totalWidth);
            $("#slipping-container-"+x).css('height','250px'); // 在修改过显示规格后，需要手动设置横向总体载体元素高度
            ...
            for(y = 1;y <= MAX_Y;++y){
                ...
                $(".slipping-main-"+x+y).append("<div class='slipping-box thumbnail'><img src='/image/avatar/stand_lex.png' style='width:150px;height:240px'></div>");
